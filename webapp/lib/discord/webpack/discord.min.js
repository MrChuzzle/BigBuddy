!function (e, t) {
    ...
    return function (e) {
        ...
        "use strict";
        (function (e) {
            const i = t.Package = s(49), {Error: n, RangeError: r} = s(3), o = t.browser = "undefined" != typeof window;
            t.DefaultOptions = {
                shardCount: 1,
                ...
                ws: {
                    large_threshold: 250,
                    compress: !1,
                    properties: {$os: o ? "browser" : e.platform, $browser: "discord.js", $device: "discord.js"},
                    version: 6
                },
                http: {
                    version: 7,
            ...
            const a = ["webp", "png", "jpg", "gif"], c = Array.from({length: 8}, (e, t) => 2 ** (t + 4));

            function l(e, {format: t = "webp", size: s} = {}) {
            ...
            t.Endpoints = {
                CDN: e => ({
                    ...
                    Banner: (t, s, i = "webp", n) => l(`${e}/banners/${t}/${s}`, {format: i, size: n}),
                    Icon: (t, s, i = "webp", n, r = !1) => (r && (i = s.startsWith("a_") ? "gif" : i), l(`${e}/icons/${t}/${s}`, {
                        format: i,
                        size: n
                    })),
                    AppIcon: (t, s, {format: i = "webp", size: n} = {}) => l(`${e}/app-icons/${t}/${s}`, {
                        size: n,
                        format: i
                    }),
                    AppAsset: (t, s, {format: i = "webp", size: n} = {}) => l(`${e}/app-assets/${t}/${s}`, {
                        size: n,
                        format: i
                    }),
                    GDMIcon: (t, s, i = "webp", n) => l(`${e}/channel-icons/${t}/${s}`, {size: n, format: i}),
                    Splash: (t, s, i = "webp", n) => l(`${e}/splashes/${t}/${s}`, {size: n, format: i}),
                    DiscoverySplash: (t, s, i = "webp", n) => l(`${e}/discovery-splashes/${t}/${s}`, {
                        size: n,
                        format: i
                    }),
                    TeamIcon: (t, s, {format: i = "webp", size: n} = {}) => l(`${e}/team-icons/${t}/${s}`, {
                        size: n,
                        format: i
                    })
                }), invite: (e, t) => `${e}/${t}`, botGateway: "/gateway/bot"
            }, t.Status = {
                READY: 0,
                CONNECTING: 1,
                RECONNECTING: 2,
                ...
                NEWS: 5,
                STORE: 6
            }, t.ClientApplicationAssetTypes = {SMALL: 1, BIG: 2}, t.Colors = {
                DEFAULT: 0,
                WHITE: 16777215,
                AQUA: 1752220,
                GREEN: 3066993,
        ...
        e.exports = class GenericAction {
            ...
            getChannel(e) {
                ...
                return e.channel || this.getPayload({
                    id: t,
                    guild_id: e.guild_id,
                    recipients: [e.author || {id: e.user_id}]
            ...
            getMember(e, t) {
                const s = e.user.id;
                return this.getPayload({user: {id: s}}, t.members, s, i.GUILD_MEMBER)
            }

            getUser(e) {
                const t = e.user_id;
                return e.user || this.getPayload({id: t}, this.client.users, t, i.USER)
            }
        }
    }, function (e, t, s) {
        "use strict";
        ...
        "use strict";
        const {parse: i} = s(29),
            n = s(30), {Colors: r, DefaultOptions: o, Endpoints: a} = s(0), {Error: c, RangeError: l, TypeError: h} = s(3),
        ...
        class Util {
            ...
            static flatten(e, ...t) {
                if (!u(e)) return e;
                t = Object.assign(...Object.keys(e).filter(e => !e.startsWith("_")).map(e => ({[e]: !0})), ...t);
                const i = {};
                for (let [n, r] of Object.entries(t)) {
                    if (!r) continue;
                    r = !0 === r ? n : r;
                    const t = e[n], o = u(t), a = o && "function" == typeof t.valueOf ? t.valueOf() : null;
            ...
            static splitMessage(e, {maxLength: t = 2e3, char: s = "\n", prepend: i = "", append: n = ""} = {}) {
            ...
            static escapeMarkdown(e, {codeBlock: t = !0, inlineCode: s = !0, bold: i = !0, italic: n = !0, underline: r = !0, strikethrough: o = !0, spoiler: a = !0, codeBlockContent: c = !0, inlineCodeContent: l = !0} = {}) {
            ...
            static parseEmoji(e) {
                ...
                return t ? {animated: Boolean(t[1]), name: t[2], id: t[3] || null} : null
            }
            ...
            static str2ab(e) {
                const t = new ArrayBuffer(2 * e.length), s = new Uint16Array(t);
            ...
            static setPosition(e, t, s, i, n, r) {
                ...
                return Util.moveElementInArray(o, e, t, s), o = o.map((e, t) => ({
                    id: e.id,
                    position: t
                })), n.patch({data: o, reason: r}).then(() => o)
            }
            ...
            static idToBinary(e) {
                let t = "", s = parseInt(e.slice(0, -10)) || 0, i = parseInt(e.slice(-10));
            ...
            static binaryToID(e) {
                let t = "";
                for (; e.length > 50;) {
                    const s = parseInt(e.slice(0, -32), 2), i = parseInt((s % 10).toString(2) + e.slice(-32), 2);
        ...
        e.exports = class BaseManager {
            constructor(e, t, r, o = i, ...a) {
                if (n || (n = s(18)), Object.defineProperty(this, "holds", {value: n.get(r.name) || r}), Object.defineProperty(this, "client", {value: e}), this.cacheType = o, this.cache = new o(...a), t) for (const e of t) this.add(e)
            }

            add(e, t = !0, {id: s, extras: i = []} = {}) {
        ...
        e.exports = class SnowflakeUtil {
            ...
            static deconstruct(e) {
                const t = i.idToBinary(e).toString(2).padStart(64, "0"), s = {
        ...
        "use strict";
        const i = s(29), n = s(29), r = s(30), {Error: o, TypeError: a} = s(3), {browser: c} = s(0), l = s(4);
        ...
        "use strict";
        const i = s(5), {Presence: n} = s(12), r = s(17), o = s(21), a = s(27), {Error: c} = s(3), l = s(59), h = s(8);
        ...
        class GuildMember extends i {
            ...
            get voice() {
                return this.guild.voiceStates.cache.get(this.id) || new o(this.guild, {user_id: this.id})
            }
            ...
            hasPermission(e, {checkAdmin: t = !0, checkOwner: s = !0} = {}) {
            ...
            kick(e) {
                return this.client.api.guilds(this.guild.id).members(this.user.id).delete({reason: e}).then(() => this)
            }
        ...
        "use strict";
        const i = s(26), n = s(13), {WebhookTypes: r} = s(0), o = s(9), a = s(7);

        class Webhook {
            constructor(e, t) {
                Object.defineProperty(this, "client", {value: e}), t && this._patch(t)
            }
            ...
            async send(e, t) {
                let s;
                if (e instanceof i) s = e.resolveData(); else if (s = i.create(this, e, t).resolveData(), Array.isArray(s.data.content)) return Promise.all(s.split().map(this.send.bind(this)));
                const {data: n, files: r} = await s.resolveFiles();
            ...
            async edit({name: e = this.name, avatar: t, channel: s}, i) {
            ...
            delete(e) {
                return this.client.api.webhooks(this.id, this.token).delete({reason: e})
            }
        ...
        "use strict";
        const i = s(25), n = s(57), {ActivityTypes: r} = s(0), o = s(4);

        class Activity {
            constructor(e, t) {
                Object.defineProperty(this, "presence", {value: e}), this.name = t.name, this.type = r[t.type], this.url = t.url || null, this.details = t.details || null, this.state = t.state || null, this.applicationID = t.application_id || null, this.timestamps = t.timestamps ? {
        ...
        class RichPresenceAssets {
            constructor(e, t) {
                Object.defineProperty(this, "activity", {value: e}), this.largeText = t.large_text || null, this.smallText = t.small_text || null, this.largeImage = t.large_image || null, this.smallImage = t.small_image || null
            }

            smallImageURL({format: e, size: t} = {}) {
        ...
        t.Presence = class Presence {
            constructor(e, t = {}) {
                Object.defineProperty(this, "client", {value: e}), this.userID = t.user.id, this.guild = t.guild || null, this.patch(t)
            }
        ...
        "use strict";
        const i = s(5), {ChannelTypes: n} = s(0), r = s(7);
        e.exports = class Channel extends i {
            ...
            toJSON(...e) {
                return super.toJSON({createdTimestamp: !0}, ...e)
            }
        }
    }, function (e, t, s) {
        "use strict";
        const {RangeError: i} = s(3);
        ...
        "use strict";
        const i = s(13), n = s(16), r = s(35), o = s(17), {Error: a, TypeError: c} = s(3), l = s(2), h = s(8), u = s(4);
        e.exports = class GuildChannel extends i {
            ...
            _patch(e) {
                if (super._patch(e), this.name = e.name, this.rawPosition = e.position, this.parentID = e.parent_id, this.permissionOverwrites = new l, e.permission_overwrites) for (const t of e.permission_overwrites) this.permissionOverwrites.set(t.id, new r(this, t))
            }
            ...
            memberPermissions(e) {
                ...
                const t = e.roles.cache, s = new h(t.map(e => e.permissions));
            ...
            rolePermissions(e) {
                ...
                const t = this.permissionOverwrites.get(this.guild.id), s = this.permissionOverwrites.get(e.id);
            ...
            createOverwrite(e, t, s) {
                if (!(e = this.guild.roles.resolve(e) || this.client.users.resolve(e))) return Promise.reject(new c("INVALID_TYPE", "parameter", "User nor a Role", !0));
                const i = e instanceof o ? "role" : "member", {allow: n, deny: a} = r.resolveOverwriteOptions(t);
            ...
            async edit(e, t) {
                void 0 !== e.position && await u.setPosition(this, e.position, !1, this.guild._sortedChannels(this), this.client.api.guilds(this.guild.id).channels, t).then(e => {
                    this.client.actions.GuildChannelsPositionUpdate.handle({guild_id: this.guild.id, channels: e})
                });
            ...
            setParent(e, {lockPermissions: t = !0, reason: s} = {}) {
                return this.edit({
            ...
            setPosition(e, {relative: t, reason: s} = {}) {
            ...
            createInvite({temporary: e = !1, maxAge: t = 86400, maxUses: s = 0, unique: i, reason: r} = {}) {
            ...
            async fetchInvites() {
                const e = await this.client.api.channels(this.id).invites.get(), t = new l;
                for (const s of e) {
            ...
            delete(e) {
                return this.client.api.channels(this.id).delete({reason: e}).then(() => this)
            }
        }
    }, function (e, t, s) {
        "use strict";
        const i = s(5), {Endpoints: n} = s(0), r = s(8);
        e.exports = class Invite extends i {
            ...
            delete(e) {
                return this.client.api.invites[this.code].delete({reason: e}).then(() => this)
            }
        ...
        "use strict";
        const i = s(5), {Error: n, TypeError: r} = s(3), o = s(8), a = s(7), c = s(4);
        e.exports = class Role extends i {
            ...
            async edit(e, t) {
                return void 0 !== e.permissions ? e.permissions = o.resolve(e.permissions) : e.permissions = this.permissions.bitfield, void 0 !== e.position && await c.setPosition(this, e.position, !1, this.guild._sortedRoles(), this.client.api.guilds(this.guild.id).roles, t).then(e => {
                    this.client.actions.GuildRolesPositionUpdate.handle({guild_id: this.guild.id, roles: e})
            ...
            delete(e) {
                return this.client.api.guilds[this.guild.id].roles[this.id].delete({reason: e}).then(() => (this.client.actions.GuildRoleDelete.handle({
                    guild_id: this.guild.id,
                    role_id: this.id
                }), this))
            }
            ...
            toJSON() {
                return super.toJSON({createdTimestamp: !0})
            }
        ...
        "use strict";
        const i = s(33), {Error: n} = s(3), r = s(56), o = s(8);
        ...
        class GuildEmoji extends i {
            ...
            delete(e) {
                return this.client.api.guilds(this.guild.id).emojis(this.id).delete({reason: e}).then(() => this)
            }
        ...
        "use strict";
        const i = s(5), {Presence: n} = s(12), r = s(27), {Error: o} = s(3), a = s(7);
        ...
        class User extends i {
            ...
            get presence() {
                for (const e of this.client.guilds.cache.values()) if (e.presences.cache.has(this.id)) return e.presences.cache.get(this.id);
                return new n(this.client, {user: {id: this.id}})
            }

            avatarURL({format: e, size: t, dynamic: s} = {}) {
            ...
            async createDM() {
                const {dmChannel: e} = this;
                if (e && !e.partial) return e;
                const t = await this.client.api.users(this.client.user.id).channels.post({data: {recipient_id: this.id}});
        ...
        "use strict";
        const i = s(5), {Error: n, TypeError: r} = s(3), {browser: o} = s(0);
        e.exports = class VoiceState extends i {
            ...
            setMute(e, t) {
                return this.member ? this.member.edit({mute: e}, t) : Promise.reject(new n("VOICE_STATE_UNCACHED_MEMBER"))
            }

            setDeaf(e, t) {
                return this.member ? this.member.edit({deaf: e}, t) : Promise.reject(new n("VOICE_STATE_UNCACHED_MEMBER"))
            }
            ...
            setChannel(e, t) {
                return this.member ? this.member.edit({channel: e}, t) : Promise.reject(new n("VOICE_STATE_UNCACHED_MEMBER"))
            }
        ...
        "use strict";
        const i = s(26), n = s(5), r = s(41), o = s(36), a = s(37), c = s(62),
            l = s(63), {Error: h, TypeError: u} = s(3), d = s(105), p = s(2), {MessageTypes: m} = s(0), g = s(38),
            E = s(8), f = s(4);
        e.exports = class Message extends n {
            ...
            _patch(e) {
                if (this.id = e.id, this.type = m[e.type], this.content = e.content, this.author = e.author ? this.client.users.add(e.author, !e.webhook_id) : null, this.pinned = e.pinned, this.tts = e.tts, this.nonce = e.nonce, this.system = 0 !== e.type, this.embeds = (e.embeds || []).map(e => new a(e, !0)), this.attachments = new p, e.attachments) for (const t of e.attachments) this.attachments.set(t.id, new o(t.url, t.filename, t));
                if (this.createdTimestamp = new Date(e.timestamp).getTime(), this.editedTimestamp = e.edited_timestamp ? new Date(e.edited_timestamp).getTime() : null, this.reactions = new d(this), e.reactions && e.reactions.length > 0) for (const t of e.reactions) this.reactions.add(t);
                ...
                } : null, this._edits = [], this.member && e.member ? this.member._patch(e.member) : e.member && this.guild && this.author && this.guild.members.add(Object.assign(e.member, {user: this.author})), this.flags = new g(e.flags).freeze(), this.reference = e.message_reference ? {
            ...
            edit(e, t) {
                const {data: s} = e instanceof i ? e.resolveData() : i.create(this, e, t).resolveData();
                return this.client.api.channels[this.channel.id].messages[this.id].patch({data: s}).then(e => {
                    const t = this._clone();
                    return t._patch(e), t
                })
            }
            ...
            delete(e = {}) {
                ...
                const {timeout: t = 0, reason: s} = e;
                return t <= 0 ? this.channel.messages.delete(this.id, s).then(() => this) : new Promise(e => {
                    this.client.setTimeout(() => {
                        e(this.delete({reason: s}))
                    }, t)
                })
            }

            reply(e, t) {
                return this.channel.send(e instanceof i ? e : i.transformOptions(e, t, {reply: this.member || this.author}))
            }
            ...
            suppressEmbeds(e = !0) {
                ...
                return e ? t.add(g.FLAGS.SUPPRESS_EMBEDS) : t.remove(g.FLAGS.SUPPRESS_EMBEDS), this.edit({flags: t})
            }
        ...
        function u(e, t, s, i) {
            var n, r, o, a;
            if (l(s), void 0 === (r = e._events) ? (r = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== r.newListener && (e.emit("newListener", t, s.listener ? s.listener : s), r = e._events), o = r[t]), void 0 === o) o = r[t] = s, ++e._eventsCount; else if ("function" == typeof o ? o = r[t] = i ? [s, o] : [o, s] : i ? o.unshift(s) : o.push(s), (n = h(e)) > 0 && o.length > n && !o.warned) {
                o.warned = !0;
        ...
        function p(e, t, s) {
            var i = {fired: !1, wrapFn: void 0, target: e, type: t, listener: s}, n = d.bind(i);
        ...
        e.exports = class Emoji extends i {
            ...
            toJSON() {
                return super.toJSON({guild: "guildID", createdTimestamp: !0, url: !0, identifier: !0})
            }
        }
    }, function (e, t, s) {
        "use strict";
        const i = s(36), n = s(37), {RangeError: r} = s(3), {browser: o} = s(0), a = s(9), c = s(38), l = s(4);
        ...
        class APIMessage {
            ...
            resolveData() {
                ...
                const e = this.makeContent(), t = Boolean(this.options.tts);
                let s;
            ...
            split() {
                ...
                for (let t = 0; t < this.data.content.length; t++) {
                    ...
                    }, i = {...this.options, content: this.data.content[t]}) : (s = {
                        content: this.data.content[t],
                        tts: this.data.tts
                    }, i = {content: this.data.content[t], tts: this.data.tts});
            ...
            static transformOptions(e, t, s = {}, r = !1) {
                if (t || "object" != typeof e || Array.isArray(e) || (t = e, e = void 0), t) {
                    if (t instanceof n) return r ? {content: e, embeds: [t], ...s} : {content: e, embed: t, ...s};
                    if (t instanceof i) return {content: e, files: [t], ...s}
                } else t = {};
                if (Array.isArray(t)) {
                    const [i, n] = this.partitionMessageAdditions(t);
                    return r ? {content: e, embeds: i, files: n, ...s} : {content: e, embed: i[0], files: n, ...s}
                }
                if (Array.isArray(e)) {
                    const [t, i] = this.partitionMessageAdditions(e);
                    if (t.length || i.length) return r ? {embeds: t, files: i, ...s} : {embed: t[0], files: i, ...s}
                }
                return {content: e, ...t, ...s}
            }

            static create(e, t, i, n = {}) {
                const r = s(11), o = s(39), a = e instanceof r || e instanceof o;
        ...
        "use strict";
        const i = s(58), n = s(26), r = s(7), o = s(2), {RangeError: a, TypeError: c} = s(3);
        ...
        class TextBasedChannel {
            ...
            async send(e, t) {
                ...
                let o;
                if (e instanceof n) o = e.resolveData(); else if (o = n.create(this, e, t).resolveData(), Array.isArray(o.data.content)) return Promise.all(o.split().map(this.send.bind(this)));
                const {data: a, files: c} = await o.resolveFiles();
            ...
            startTyping(e) {
                ...
                return t.promise = new Promise((s, i) => {
                    ...
                    Object.assign(t, {
                        count: e || 1, interval: this.client.setInterval(() => {
                            n.post().catch(e => {
            ...
            async bulkDelete(e, t = !1) {
                if (Array.isArray(e) || e instanceof o) {
                    ...
                    if (1 === s.length) {
                        ...
                        const e = this.client.actions.MessageDelete.getMessage({message_id: s[0]}, this);
                        return e ? new o([[e.id, e]]) : new o
                    }
                    return await this.client.api.channels[this.id].messages["bulk-delete"].post({data: {messages: s}}), s.reduce((e, t) => e.set(t, this.client.actions.MessageDeleteBulk.getMessage({message_id: t}, this)), new o)
                }
                if (!isNaN(e)) {
                    const s = await this.messages.fetch({limit: e});
        ...
        "use strict";
        const i = s(6), n = s(22), r = s(2), o = s(106);
        e.exports = class MessageManager extends i {
            ...
            add(e, t) {
                return super.add(e, t, {extras: [this.channel]})
            }
            ...
            async delete(e, t) {
                (e = this.resolveID(e)) && await this.client.api.channels(this.channel.id).messages(e).delete({reason: t})
            }
            ...
            async _fetchMany(e = {}, t) {
                const s = await this.client.api.channels[this.channel.id].messages.get({query: e}), i = new r;
        ...
        (function (t, i) {
            s(53);
            const n = s(24), r = s(86), {DefaultOptions: o} = s(0), a = s(4);
            e.exports = class BaseClient extends n {
                ...
                toJSON(...e) {
                    return a.flatten(this, {domain: !1}, ...e)
                }
            }
        }).call(this, s(51).setImmediate, s(51).clearImmediate)
    }, function (e, t, s) {
        "use strict";
        const i = s(13), n = s(27), r = s(28);
        ...
        "use strict";
        const i = s(15), n = s(11), r = s(27), o = s(28), a = s(2), c = s(9);
        ...
        class TextChannel extends i {
            ...
            _patch(e) {
                if (super._patch(e), this.topic = e.topic, this.nsfw = e.nsfw, this.lastMessageID = e.last_message_id, this.rateLimitPerUser = e.rate_limit_per_user || 0, this.lastPinTimestamp = e.last_pin_timestamp ? new Date(e.last_pin_timestamp).getTime() : null, e.messages) for (const t of e.messages) this.messages.add(t)
            }

            setRateLimitPerUser(e, t) {
                return this.edit({rateLimitPerUser: e}, t)
            }
            ...
            async createWebhook(e, {avatar: t, reason: s} = {}) {
        ...
        "use strict";
        const i = s(17), {TypeError: n} = s(3), r = s(8), o = s(4);
        e.exports = class PermissionOverwrites {
            constructor(e, t) {
                Object.defineProperty(this, "channel", {value: e}), t && this._patch(t)
            }
            ...
            update(e, t) {
                const {allow: s, deny: i} = this.constructor.resolveOverwriteOptions(e, this);
            ...
            delete(e) {
                return this.channel.client.api.channels[this.channel.id].permissions[this.id].delete({reason: e}).then(() => this)
            }
            ...
            static resolveOverwriteOptions(e, {allow: t, deny: s} = {}) {
                t = new r(t), s = new r(s);
            ...
            static resolve(e, t) {
                ...
                return {id: s.id, type: o, allow: r.resolve(e.allow), deny: r.resolve(e.deny)}
            }
        }
    }, function (e, t, s) {
        "use strict";
        ...
        e.exports = class MessageEmbed {
            ...
            addField(e, t, s) {
                return this.addFields({name: e, value: t, inline: s})
            }
            ...
            setAuthor(e, t, s) {
                return this.author = {name: n.resolveString(e), iconURL: t, url: s}, this
            }
            ...
            setFooter(e, t) {
                return e = n.resolveString(e), this.footer = {text: e, iconURL: t}, this
            }
            ...
            toJSON() {
                return {
                    ...
                    footer: this.footer ? {text: this.footer.text, icon_url: this.footer.iconURL} : null
                }
            }
            ...
            static normalizeField(e, t, s = !1) {
                ...
                return {name: e, value: t, inline: s}
            }
        ...
        class WebhookClient extends i {
            constructor(e, t, s) {
                super(s), Object.defineProperty(this, "client", {value: this}), this.id = e, Object.defineProperty(this, "token", {
                    value: t,
                    writable: !0,
                    configurable: !0
                })
        ...
        "use strict";
        const i = s(5), n = s(60), {ClientApplicationAssetTypes: r, Endpoints: o} = s(0), a = s(7), c = Object.keys(r);
        e.exports = class ClientApplication extends i {
            ...
            iconURL({format: e, size: t} = {}) {
                return this.icon ? this.client.rest.cdn.AppIcon(this.id, this.icon, {format: e, size: t}) : null
            }

            coverImage({format: e, size: t} = {}) {
        ...
        "use strict";
        const i = s(19), n = s(43), r = s(64), o = s(4);
        e.exports = class MessageReaction {
            constructor(e, t, s) {
                Object.defineProperty(this, "client", {value: e}), this.message = s, this.me = t.me, this.users = new r(e, void 0, this), this._emoji = new n(this, t.emoji), this._patch(t)
            }
            ...
            async fetch() {
                ...
                return this._patch(e || {count: 0}), this
            }

            toJSON() {
                return o.flatten(this, {emoji: "emojiID", message: "messageID"})
            }
        ...
        e.exports = class ReactionEmoji extends i {
            ...
            toJSON() {
                return n.flatten(this, {identifier: !0})
            }
        ...
        "use strict";
        const i = s(5), n = s(69), r = s(46), o = s(45), a = s(16), c = s(47), l = s(11), h = s(70), u = s(48),
            d = s(71), p = s(72), m = s(73), g = s(108),
            E = s(2), {ChannelTypes: f, DefaultMessageNotifications: _, PartialTypes: I, VerificationLevels: A, ExplicitContentFilterLevels: y} = s(0),
            v = s(9), D = s(7), T = s(74), b = s(4);
        e.exports = class Guild extends i {
            ...
            _patch(e) {
                ...
                if (e.owner_id && (this.ownerID = e.owner_id), e.presences) for (const t of e.presences) this.presences.add(Object.assign(t, {guild: this}));
                if (e.voice_states) {
                ...
                if (this.emojis) e.emojis && this.client.actions.GuildEmojisUpdate.handle({
                    guild_id: this.id,
                    emojis: e.emojis
                }); else if (this.emojis = new u(this), e.emojis) for (const t of e.emojis) this.emojis.add(t)
            }

            bannerURL({format: e, size: t} = {}) {
            ...
            iconURL({format: e, size: t, dynamic: s} = {}) {
            ...
            splashURL({format: e, size: t} = {}) {
                return this.splash ? this.client.rest.cdn.Splash(this.id, this.splash, e, t) : null
            }

            get owner() {
                return this.members.cache.get(this.ownerID) || (this.client.options.partials.includes(I.GUILD_MEMBER) ? this.members.add({user: {id: this.ownerID}}, !0) : null)
            }
            ...
            get me() {
                return this.members.cache.get(this.client.user.id) || (this.client.options.partials.includes(I.GUILD_MEMBER) ? this.members.add({user: {id: this.client.user.id}}, !0) : null)
            }
            ...
            createIntegration(e, t) {
                return this.client.api.guilds(this.id).integrations.post({data: e, reason: t}).then(() => this)
            }
            ...
            addMember(e, t) {
                ...
                return this.client.api.guilds(this.id).members(e).put({data: t}).then(e => this.members.add(e))
            }
            ...
            setSystemChannelFlags(e, t) {
                return this.edit({systemChannelFlags: e}, t)
            }
            ...
            async setIcon(e, t) {
                return this.edit({icon: await v.resolveImage(e), reason: t})
            }
            ...
            async setSplash(e, t) {
                return this.edit({splash: await v.resolveImage(e), reason: t})
            }

            async setBanner(e, t) {
                return this.edit({banner: await v.resolveImage(e), reason: t})
            }

            setChannelPositions(e) {
                const t = e.map(e => ({id: this.client.channels.resolveID(e.channel), position: e.position}));
                return this.client.api.guilds(this.id).channels.patch({data: t}).then(() => this.client.actions.GuildChannelsPositionUpdate.handle({
                    guild_id: this.id,
                    channels: t
                }).guild)
            }
            ...
            setRolePositions(e) {
                return e = e.map(e => ({
                    ...
                    position: e.position
                })), this.client.api.guilds(this.id).roles.patch({data: e}).then(() => this.client.actions.GuildRolesPositionUpdate.handle({
                    guild_id: this.id,
                    roles: e
                }).guild)
            }
            ...
            leave() {
                return this.ownerID === this.client.user.id ? Promise.reject(new Error("GUILD_OWNED")) : this.client.api.users("@me").guilds(this.id).delete().then(() => this.client.actions.GuildDelete.handle({id: this.id}).guild)
            }
        ...
        e.exports = class Integration extends i {
            ...
            delete(e) {
                return this.client.api.guilds(this.guild.id).integrations(this.id).delete({reason: e}).then(() => this)
            }
        ...
        e.exports = class GuildPreview extends i {
            ...
            discoverySplashURL({format: e, size: t} = {}) {
        ...
        "use strict";
        const i = s(6), {TypeError: n} = s(3), r = s(19), o = s(43), a = s(2), c = s(9);
        e.exports = class GuildEmojiManager extends i {
            ...
            add(e, t) {
                return super.add(e, t, {extras: [this.guild]})
            }

            async create(e, t, {roles: s, reason: i} = {}) {
                if (!(e = await c.resolveImage(e))) throw new n("REQ_RESOURCE_TYPE");
                const r = {image: e, name: t};
                if (s) {
                    r.roles = [];
        ...
        e.exports = {version: "12.1.1", homepage: "https://github.com/discordjs/discord.js#readme"}
    }, function (e, t, s) {
        "use strict";
        const i = Symbol("code"), n = new Map;
        ...
        e.exports = {
            ...
            }, Error: r(Error), TypeError: r(TypeError), RangeError: r(RangeError)
        }
    }, function (e, t, s) {
        (function (e) {
        ...
        (function (e, t) {
            !function (e, s) {
                "use strict";
                if (!e.setImmediate) {
                    var i, n, r, o, a, c = 1, l = {}, h = !1, u = e.document,
                ...
                function m(e) {
                    if (h) setTimeout(m, 0, e); else {
                        var t = l[e];
                        if (t) {
                            h = !0;
                            try {
                                !function (e) {
                                    var t = e.callback, s = e.args;
                                    switch (s.length) {
                                        case 0:
                                            t();
                                            break;
        ...
        "use strict";
        const {TypeError: i} = s(3), n = s(2);
        e.exports = class GuildEmojiRoleManager {
            constructor(e) {
                this.emoji = e, this.guild = e.guild, Object.defineProperty(this, "client", {value: e.client})
            }
        ...
        e.exports = class GuildMemberRoleManager {
            constructor(e) {
                this.member = e, this.guild = e.guild, Object.defineProperty(this, "client", {value: e.client})
            }
            ...
            async add(e, t) {
                ...
                }
                {
                    ...
                    await this.client.api.guilds[this.guild.id].members[this.member.id].roles[e.id].put({reason: t});
            ...
            async remove(e, t) {
                ...
                }
                {
                    ...
                    await this.client.api.guilds[this.guild.id].members[this.member.id].roles[e.id].delete({reason: t});
                    const s = this.member._clone(), n = this._roles.filter(t => t.id !== e.id);
                    return s._roles = [...n.keys()], s
                }
            }

            set(e, t) {
                return this.member.edit({roles: e}, t)
            }
        ...
        "use strict";
        const i = s(5), n = s(61), r = s(2), o = s(7);
        e.exports = class Team extends i {
            ...
            iconURL({format: e, size: t} = {}) {
                return this.icon ? this.client.rest.cdn.TeamIcon(this.id, this.icon, {format: e, size: t}) : null
            }
        ...
        "use strict";
        const i = s(5), {MembershipStates: n} = s(0);
        ...
        "use strict";
        const i = s(2), {ChannelTypes: n} = s(0), r = s(4);

        class MessageMentions {
            constructor(e, t, s, r, o) {
                if (Object.defineProperty(this, "client", {value: e.client}), Object.defineProperty(this, "guild", {value: e.guild}), Object.defineProperty(this, "_content", {value: e.content}), this.everyone = Boolean(r), t) if (t instanceof i) this.users = new i(t); else {
                    this.users = new i;
                    for (const s of t) {
                        s.member && e.guild && e.guild.members.add(Object.assign(s.member, {user: s}));
                        const t = e.client.users.add(s);
                        this.users.set(t.id, t)
                    }
                } else this.users = new i;
                if (s) if (s instanceof i) this.roles = new i(s); else {
                    this.roles = new i;
                    for (const t of s) {
                ...
                if (this._members = null, this._channels = null, o) if (o instanceof i) this.crosspostedChannels = new i(o); else {
            ...
            has(e, {ignoreDirect: t = !1, ignoreRoles: i = !1, ignoreEveryone: n = !1} = {}) {
                if (!n && this.everyone) return !0;
                const r = s(10);
                if (!i && e instanceof r) for (const t of this.roles.values()) if (e.roles.cache.has(t.id)) return !0;
                if (!t) {
                    const t = e.id || e;
            ...
            toJSON() {
                return r.flatten(this, {members: !0, channels: !0})
            }
        }
        ...
        "use strict";
        const i = s(40), n = s(2), {Events: r} = s(0);
        ...
        "use strict";
        const i = s(6), {Error: n} = s(3), r = s(2);
        e.exports = class ReactionUserManager extends i {
            constructor(e, t, s) {
                super(e, t, {name: "User"}), this.reaction = s
            }

            async fetch({limit: e = 100, after: t, before: s} = {}) {
            ...
            remove(e = this.reaction.message.client.user) {
                const t = this.reaction.message, s = t.client.users.resolveID(e);
        ...
        "use strict";
        const i = s(15), {Error: n} = s(3), r = s(2), {browser: o} = s(0), a = s(8);
        ...
        "use strict";
        const i = s(45), n = s(11), r = s(2), {PartialTypes: o} = s(0), a = s(7), c = s(4), l = {
            ALL: "ALL",
            GUILD: "GUILD",
            CHANNEL: "CHANNEL",
            USER: "USER",
        ...
        class GuildAuditLogs {
            constructor(e, t) {
                if (t.users) for (const s of t.users) e.client.users.add(s);
                if (this.webhooks = new r, t.webhooks) for (const s of t.webhooks) this.webhooks.set(s.id, new n(e.client, s));
                if (this.integrations = new r, t.integrations) for (const s of t.integrations) this.integrations.set(s.id, new i(e.client, s, e));
                this.entries = new r;
        ...
        class GuildAuditLogsEntry {
            constructor(e, t, s) {
                ...
                switch (this.targetType = r, this.actionType = GuildAuditLogs.actionType(s.action_type), this.action = Object.keys(h).find(e => h[e] === s.action_type), this.reason = s.reason || null, this.executor = t.client.options.partials.includes(o.USER) ? t.client.users.add({id: s.user_id}) : t.client.users.cache.get(s.user_id), this.changes = s.changes ? s.changes.map(e => ({
                    ...
                    case h.MESSAGE_BULK_DELETE:
                        this.extra = {
                            channel: t.channels.cache.get(s.options.channel_id) || {id: s.options.channel_id},
                    ...
                    case h.MESSAGE_UNPIN:
                        this.extra = {
                            channel: t.client.channels.cache.get(s.options.channel_id) || {id: s.options.channel_id},
                            messageID: s.options.message_id
                        };
                        break;
                    case h.MEMBER_DISCONNECT:
                        this.extra = {count: Number(s.options.count)};
                        break;
                    ...
                    case h.CHANNEL_OVERWRITE_DELETE:
                        switch (s.options.type) {
                            case"member":
                                this.extra = t.members.cache.get(s.options.id) || {id: s.options.id, type: "member"};
                                break;
                            case"role":
            ...
            toJSON() {
                return c.flatten(this, {createdTimestamp: !0})
            }
        }
        ...
        "use strict";
        const i = s(6), n = s(15), r = s(35), {ChannelTypes: o} = s(0);
        e.exports = class GuildChannelManager extends i {
            ...
            async create(e, t = {}) {
                let {type: s, topic: i, nsfw: n, bitrate: a, userLimit: c, parent: l, permissionOverwrites: h, position: u, rateLimitPerUser: d, reason: p} = t;
        ...
        "use strict";
        const i = s(6), {Error: n, TypeError: r} = s(3), o = s(10), a = s(2), {Events: c, OPCodes: l} = s(0);
        e.exports = class GuildMemberManager extends i {
            ...
            add(e, t = !0) {
                return super.add(e, t, {id: e.user.id, extras: [this.guild]})
            }
            ...
            fetch(e) {
                ...
                const t = this.client.users.resolveID(e);
                if (t) return this._fetchSingle({user: t, cache: !0});
                if (e.user) {
            ...
            prune({days: e = 7, dry: t = !1, count: s = !0, reason: i} = {}) {
            ...
            ban(e, t = {days: 0}) {
                ...
                const s = this.client.users.resolveID(e);
                return s ? this.client.api.guilds(this.guild.id).bans[s].put({query: t}).then(() => {
            ...
            unban(e, t) {
                const s = this.client.users.resolveID(e);
                return s ? this.client.api.guilds(this.guild.id).bans[s].delete({reason: t}).then(() => this.client.users.resolve(e)) : Promise.reject(new n("BAN_RESOLVE_ID"))
            }

            _fetchSingle({user: e, cache: t}) {
                const s = this.cache.get(e);
                return s && !s.partial ? Promise.resolve(s) : this.client.api.guilds(this.guild.id).members(e).get().then(e => this.add(e, t))
            }

            _fetchMany({limit: e = 0, withPresences: t = !1, user: s, query: i} = {}) {
                return new Promise((r, o) => {
                    ...
                    i || s || (i = ""), this.guild.shard.send({
                        ...
                        d: {guild_id: this.guild.id, presences: t, user_ids: s, query: i, limit: e}
                    });
                    const h = new a, u = i || e || t || s, d = (t, i) => {
        ...
        e.exports = class PresenceManager extends i {
            ...
            add(e, t) {
                ...
                return s ? s.patch(e) : super.add(e, t, {id: e.user.id})
            }
        ...
        "use strict";
        const i = s(6), n = s(17), r = s(8), {resolveColor: o} = s(4);
        e.exports = class RoleManager extends i {
            ...
            create({data: e = {}, reason: t} = {}) {
                return e.color && (e.color = o(e.color)), e.permissions && (e.permissions = r.resolve(e.permissions)), this.guild.client.api.guilds(this.guild.id).roles.post({
                    ...
                    const {role: i} = this.client.actions.GuildRoleCreate.handle({guild_id: this.guild.id, role: s});
        ...
        "use strict";
        const {Presence: i} = s(12), {TypeError: n} = s(3), r = s(2), {ActivityTypes: o, OPCodes: a} = s(0);
        e.exports = class ClientPresence extends i {
            constructor(e, t = {}) {
                super(e, Object.assign(t, {status: "online", user: {id: null}}))
            }
            ...
            async set(e) {
                ...
                if (this.patch(t), void 0 === e.shardID) this.client.ws.broadcast({
                    op: a.STATUS_UPDATE,
                    d: t
                }); else if (Array.isArray(e.shardID)) for (const s of e.shardID) this.client.ws.shards.get(s).send({
                    op: a.STATUS_UPDATE,
                    d: t
                }); else this.client.ws.shards.get(e.shardID).send({op: a.STATUS_UPDATE, d: t});
                return this
            }

            async _parse({status: e, since: t, afk: s, activity: i}) {
        ...
        class ClientUser extends (n.get("User")) {
            ...
            edit(e) {
                return this.client.api.users("@me").patch({data: e}).then(e => {
                    this.client.token = e.token;
                    const {updated: t} = this.client.actions.UserUpdate.handle(e);
                    return t || this
                })
            }
            ...
            async setAvatar(e) {
                return this.edit({avatar: await i.resolveImage(e)})
            }
            ...
            setActivity(e, t = {}) {
                if (!e) return this.setPresence({activity: null, shardID: t.shardID});
                const s = Object.assign({}, t, "object" == typeof e ? e : {name: e});
                return this.setPresence({activity: s, shardID: s.shardID})
            }
        ...
        "use strict";
        const i = s(6), n = s(13), {Events: r} = s(0);
        ...
        "use strict";
        const i = s(6), n = s(44), r = s(15), o = s(19), a = s(10), c = s(16),
            l = s(17), {Events: h, VerificationLevels: u, DefaultMessageNotifications: d, ExplicitContentFilterLevels: p} = s(0),
            m = s(9), g = s(8), {resolveColor: E} = s(4);
        e.exports = class GuildManager extends i {
            ...
            async create(e, {channels: t = [], defaultMessageNotifications: s, explicitContentFilter: i, icon: n = null, region: r, roles: o = [], verificationLevel: a} = {}) {
                ...
                for (const e of t) if (e.parent_id = e.parentID, delete e.parentID, e.permissionOverwrites) {
        ...
        "use strict";
        const i = s(6), n = s(10), r = s(22), o = s(20);
        ...
        class Collection extends Map {
            constructor(e) {
                super(e), Object.defineProperty(this, "_array", {
                    ...
                    writable: !0,
                    configurable: !0
                }), Object.defineProperty(this, "_keyArray", {value: null, writable: !0, configurable: !0})
            }
            ...
            random(e) {
                let t = this.array();
                return void 0 === e ? t[Math.floor(Math.random() * t.length)] : 0 !== t.length && e ? (t = t.slice(), Array.from({length: e}, () => t.splice(Math.floor(Math.random() * t.length), 1)[0])) : []
            }
            ...
            equals(e) {
                ...
                for (const [t, s] of this) if (!e.has(t) || s !== e.get(t)) return !1;
                return !0
            }
        ...
        "use strict";
        const i = s(87), n = s(91), r = s(92), {Error: o} = s(3), a = s(2), {Endpoints: c} = s(0);
        e.exports = class RESTManager {
            ...
            push(e, t) {
                return new Promise((s, i) => {
                    e.push({request: t, resolve: s, reject: i, retries: 0}).catch(i)
                })
            }
        ...
        "use strict";
        const i = s(88), n = s(89), r = s(90), o = s(30), {browser: a, UserAgent: c} = s(0);
        if (i.Agent) var l = new i.Agent({keepAlive: !0});
        e.exports = class APIRequest {
            ...
            make() {
                ...
                const i = new n, h = this.client.setTimeout(() => i.abort(), this.client.options.restRequestTimeout);
                return o(e, {
                    method: this.method,
                    headers: s,
                    agent: l,
        ...
        "use strict";
        const i = s(54), n = s(55), {Events: {RATE_LIMIT: r}, browser: o} = s(0), a = s(4);
        ...
        e.exports = class RequestHandler {
            ...
            async execute(e) {
                ...
                this.busy = !0;
                const {reject: t, request: s, resolve: o} = e;
                if (this.limited) {
                ...
                if (h && h.headers) {
                    const t = h.headers.get("date"), s = h.headers.get("x-ratelimit-limit"),
                        i = h.headers.get("x-ratelimit-remaining"), n = h.headers.get("x-ratelimit-reset"),
        ...
        "use strict";
        (function (process) {
            const BaseClient = __webpack_require__(31), ActionsManager = __webpack_require__(94),
                ClientVoiceManager = __webpack_require__(131),
                WebSocketManager = __webpack_require__(132), {Error: Error, TypeError: TypeError, RangeError: RangeError} = __webpack_require__(3),
                ChannelManager = __webpack_require__(79), GuildEmojiManager = __webpack_require__(48),
                GuildManager = __webpack_require__(80), UserManager = __webpack_require__(81),
                ShardClientUtil = __webpack_require__(177), ClientApplication = __webpack_require__(41),
                GuildPreview = __webpack_require__(46), Invite = __webpack_require__(16),
                VoiceRegion = __webpack_require__(47), Webhook = __webpack_require__(11),
                Collection = __webpack_require__(2), {Events: Events, browser: browser, DefaultOptions: DefaultOptions} = __webpack_require__(0),
                DataResolver = __webpack_require__(9), Intents = __webpack_require__(82),
                Permissions = __webpack_require__(8), Structures = __webpack_require__(18);

            class Client extends BaseClient {
                constructor(e = {}) {
                    super(Object.assign({_tokenType: "Bot"}, e));
                    let t = process.env;
                    try {
                    ...
                    "undefined" === s && "number" == typeof this.options.shardCount && (this.options.shards = Array.from({length: this.options.shardCount}, (e, t) => t)), "number" === s && (this.options.shards = [this.options.shards]), Array.isArray(this.options.shards) && (this.options.shards = [...new Set(this.options.shards.filter(e => !isNaN(e) && e >= 0 && e < 1 / 0 && e === (0 | e)))]), this._validateOptions(), this.ws = new WebSocketManager(this), this.actions = new ActionsManager(this), this.voice = browser ? null : new ClientVoiceManager(this), this.shard = !browser && process.env.SHARDING_MANAGER ? ShardClientUtil.singleton(this, process.env.SHARDING_MANAGER_MODE) : null, this.users = new UserManager(this), this.guilds = new GuildManager(this), this.channels = new ChannelManager(this);
                    const i = Structures.get("ClientPresence");
                    this.presence = new i(this), Object.defineProperty(this, "token", {writable: !0}), browser || this.token || !("DISCORD_TOKEN" in process.env) ? this.token = null : this.token = process.env.DISCORD_TOKEN, this.user = null, this.readyAt = null, this.options.messageSweepInterval > 0 && this.setInterval(this.sweepMessages.bind(this), 1e3 * this.options.messageSweepInterval)
                }

                get emojis() {
                    const e = new GuildEmojiManager({client: this});
                    for (const t of this.guilds.cache.values()) if (t.available) for (const s of t.emojis.cache.values()) e.cache.set(s.id, s);
                    return e
                }
                ...
                fetchInvite(e) {
                    ...
                    return this.api.invites(t).get({query: {with_counts: !0}}).then(e => new Invite(this, e))
                }
                ...
                async generateInvite(e) {
                    ...
                    const t = await this.fetchApplication(),
                        s = new URLSearchParams({client_id: t.id, permissions: e, scope: "bot"});
                    return `${this.options.http.api}${this.api.oauth2.authorize}?${s}`
                }

                toJSON() {
                    return super.toJSON({readyAt: !1, presences: !1})
                }
        ...
        "use strict";
        const i = s(1), {Events: n} = s(0);
        e.exports = class MessageCreateAction extends i {
            handle(e) {
                const t = this.client, s = t.channels.cache.get(e.channel_id);
                if (s) {
                    const i = s.messages.cache.get(e.id);
                    if (i) return {message: i};
                    const r = s.messages.add(e), o = r.author;
                    let a = r.member;
                    return s.lastMessageID = e.id, o && (o.lastMessageID = e.id, o.lastMessageChannelID = s.id), a && (a.lastMessageID = e.id, a.lastMessageChannelID = s.id), t.emit(n.MESSAGE_CREATE, r), {message: r}
                }
                return {}
            }
        }
        ...
        e.exports = class MessageDeleteAction extends i {
            handle(e) {
                const t = this.client, s = this.getChannel(e);
                let i;
                return s && (i = this.getMessage(e, s), i && (s.messages.cache.delete(i.id), i.deleted = !0, t.emit(n.MESSAGE_DELETE, i))), {message: i}
            }
        }
    }, function (e, t, s) {
        "use strict";
        const i = s(1), n = s(2), {Events: r} = s(0);
        e.exports = class MessageDeleteBulkAction extends i {
            handle(e) {
                const t = this.client, s = t.channels.cache.get(e.channel_id);
                if (s) {
                    const i = e.ids, o = new n;
                    for (const t of i) {
                        const i = this.getMessage({id: t, guild_id: e.guild_id}, s, !1);
                        i && (i.deleted = !0, o.set(i.id, i), s.messages.cache.delete(t))
                    }
                    return o.size > 0 && t.emit(r.MESSAGE_BULK_DELETE, o), {messages: o}
                }
                return {}
            }
        }
        ...
        e.exports = class MessageUpdateAction extends i {
            handle(e) {
                ...
                if (t) {
                    const {id: s, channel_id: i, guild_id: n, author: r, timestamp: o, type: a} = e,
                        c = this.getMessage({id: s, channel_id: i, guild_id: n, author: r, timestamp: o, type: a}, t);
                    if (c) return c.patch(e), {old: c._edits[0], updated: c}
                }
                return {}
            }
        }
        ...
        "use strict";
        const i = s(1), {Events: n} = s(0), {PartialTypes: r} = s(0);
        ...
        e.exports = class MessageReactionRemoveAll extends i {
            handle(e) {
                ...
                return !!s && (s.reactions.cache.clear(), this.client.emit(n.MESSAGE_REACTION_REMOVE_ALL, s), {message: s})
            }
        }
    }, function (e, t, s) {
        "use strict";
        ...
        e.exports = class MessageReactionRemoveEmoji extends i {
            handle(e) {
                ...
                return !!i && (s.partial || s.reactions.cache.delete(i.emoji.id || i.emoji.name), this.client.emit(n.MESSAGE_REACTION_REMOVE_EMOJI, i), {reaction: i})
            }
        }
    }, function (e, t, s) {
        "use strict";
        ...
        e.exports = class ChannelCreateAction extends i {
            handle(e) {
                const t = this.client, s = t.channels.cache.has(e.id), i = t.channels.add(e);
                return !s && i && t.emit(n.CHANNEL_CREATE, i), {channel: i}
            }
        }
    }, function (e, t, s) {
        "use strict";
        const i = s(1), n = s(32), {Events: r} = s(0);
        e.exports = class ChannelDeleteAction extends i {
            ...
            handle(e) {
                ...
                if (s) {
                    if (t.channels.remove(s.id), s.deleted = !0, s.messages && !(s instanceof n)) for (const e of s.messages.cache.values()) e.deleted = !0;
        ...
        e.exports = class ReactionManager extends i {
            ...
            add(e, t) {
                return super.add(e, t, {id: e.emoji.id || e.emoji.name, extras: [this.message]})
            }
        ...
        "use strict";
        const i = s(1), n = s(13), {ChannelTypes: r} = s(0);
        ...
        e.exports = class GuildDeleteAction extends i {
            ...
            handle(e) {
                ...
                if (s) {
                    ...
                    if (e.unavailable) return s.available = !1, t.emit(n.GUILD_UNAVAILABLE, s), {guild: null};
        ...
        e.exports = class GuildUpdateAction extends i {
            handle(e) {
                const t = this.client, s = t.guilds.cache.get(e.id);
                if (s) {
                    const i = s._update(e);
                    return t.emit(n.GUILD_UPDATE, i, s), {old: i, updated: s}
                }
        ...
        "use strict";
        const i = s(1), n = s(16), {Events: r} = s(0);
        e.exports = class InviteCreateAction extends i {
            handle(e) {
                const t = this.client, s = t.channels.cache.get(e.channel_id), i = t.guilds.cache.get(e.guild_id);
                if (!s && !i) return !1;
                const o = Object.assign(e, {channel: s, guild: i}), a = new n(t, o);
                return t.emit(r.INVITE_CREATE, a), {invite: a}
            }
        }
    }, function (e, t, s) {
        "use strict";
        ...
        e.exports = class InviteDeleteAction extends i {
            handle(e) {
                ...
                if (!s && !i) return !1;
                const o = Object.assign(e, {channel: s, guild: i}), a = new n(t, o);
                return t.emit(r.INVITE_DELETE, a), {invite: a}
            }
        }
    }, function (e, t, s) {
        "use strict";
        const i = s(1), {Events: n, Status: r} = s(0);
        e.exports = class GuildMemberRemoveAction extends i {
            handle(e, t) {
                const s = this.client, i = s.guilds.cache.get(e.guild_id);
                let o = null;
        ...
        e.exports = class GuildBanRemove extends i {
            handle(e) {
                const t = this.client, s = t.guilds.cache.get(e.guild_id), i = t.users.add(e.user);
        ...
        e.exports = class GuildRoleCreate extends i {
            handle(e) {
                const t = this.client, s = t.guilds.cache.get(e.guild_id);
                let i;
                if (s) {
        ...
        e.exports = class GuildRoleDeleteAction extends i {
            handle(e) {
                const t = this.client, s = t.guilds.cache.get(e.guild_id);
                let i;
                return s && (i = s.roles.cache.get(e.role_id), i && (s.roles.cache.delete(e.role_id), i.deleted = !0, t.emit(n.GUILD_ROLE_DELETE, i))), {role: i}
            }
        }
    }, function (e, t, s) {
        "use strict";
        ...
        e.exports = class GuildRoleUpdateAction extends i {
            handle(e) {
                ...
                if (s) {
                    ...
                    return r && (i = r._update(e.role), t.emit(n.GUILD_ROLE_UPDATE, i, r)), {old: i, updated: r}
                }
                return {old: null, updated: null}
            }
        }
        ...
        e.exports = class PresenceUpdateAction extends i {
            handle(e) {
                ...
                r || "offline" === e.status || (r = s.members.add({
                    ...
                    deaf: !1,
                    mute: !1
                }), this.client.emit(n.GUILD_MEMBER_AVAILABLE, r)), s.presences.add(Object.assign(e, {guild: s})), r && this.client.listenerCount(n.PRESENCE_UPDATE) && this.client.emit(n.PRESENCE_UPDATE, i, r.presence)
            }
        }
    }, function (e, t, s) {
        "use strict";
        ...
        e.exports = class UserUpdateAction extends i {
            handle(e) {
                const t = this.client, s = t.users.cache.get(e.id), i = s._update(e);
                return i.equals(s) ? {old: null, updated: null} : (t.emit(n.USER_UPDATE, i, s), {old: i, updated: s})
            }
        }
    }, function (e, t, s) {
        "use strict";
        const i = s(1), n = s(21), {Events: r} = s(0);
        e.exports = class VoiceStateUpdate extends i {
            handle(e) {
                const t = this.client, s = t.guilds.cache.get(e.guild_id);
                if (s) {
                    const i = s.voiceStates.cache.has(e.user_id) ? s.voiceStates.cache.get(e.user_id)._clone() : new n(s, {user_id: e.user_id}),
        ...
        e.exports = class GuildEmojiCreateAction extends i {
            handle(e, t) {
                ...
                return this.client.emit(n.GUILD_EMOJI_CREATE, s), {emoji: s}
            }
        }
    }, function (e, t, s) {
        "use strict";
        ...
        e.exports = class GuildEmojiDeleteAction extends i {
            handle(e) {
                return e.guild.emojis.cache.delete(e.id), e.deleted = !0, this.client.emit(n.GUILD_EMOJI_DELETE, e), {emoji: e}
            }
        }
    }, function (e, t, s) {
        "use strict";
        ...
        e.exports = class GuildEmojiUpdateAction extends i {
            handle(e, t) {
                const s = e._update(t);
                return this.client.emit(n.GUILD_EMOJI_UPDATE, s, e), {emoji: e}
            }
        }
    }, function (e, t, s) {
        "use strict";
        ...
        e.exports = class GuildChannelsPositionUpdate extends i {
            handle(e) {
                const t = this.client.guilds.cache.get(e.guild_id);
                if (t) for (const s of e.channels) {
        ...
        "use strict";
        const i = s(24), n = s(133), r = s(77), {Error: o} = s(3),
            a = s(2), {Events: c, ShardEvents: l, Status: h, WSCodes: u, WSEvents: d} = s(0), p = s(4),
            m = [d.READY, d.RESUMED, d.GUILD_CREATE, d.GUILD_DELETE, d.GUILD_MEMBERS_CHUNK, d.GUILD_MEMBER_ADD, d.GUILD_MEMBER_REMOVE],
            g = Object.keys(u).slice(1).map(Number), E = [1e3, 4006, 4007];
        e.exports = class WebSocketManager extends i {
            constructor(e) {
                super(), Object.defineProperty(this, "client", {value: e}), this.gateway = void 0, this.totalShards = this.client.options.shards.length, this.shards = new a, Object.defineProperty(this, "shardQueue", {
                    value: new Set,
                    writable: !0
                }), Object.defineProperty(this, "packetQueue", {value: []}), this.status = h.IDLE, this.destroyed = !1, this.reconnecting = !1, this.sessionStartLimit = void 0
            }
            ...
            async connect() {
                const e = new o(u[4004]), {url: t, shards: s, session_start_limit: i} = await this.client.api.gateway.bot.get().catch(t => {
                    throw 401 === t.httpStatus ? e : t
                });
                this.sessionStartLimit = i;
                const {total: r, remaining: a, reset_after: c} = i;
                this.debug(`Fetched Gateway Information\n    URL: ${t}\n    Recommended Shards: ${s}`), this.debug(`Session Limit Information\n    Total: ${r}\n    Remaining: ${a}`), this.gateway = `${t}/`;
                let {shards: l} = this.client.options;
                return "auto" === l && (this.debug(`Using the recommended shard count provided by Discord: ${s}`), this.totalShards = this.client.options.shardCount = s, l = this.client.options.shards = Array.from({length: s}, (e, t) => t)), this.totalShards = l.length, this.debug(`Spawning shards: ${l.join(", ")}`), this.shardQueue = new Set(l.map(e => new n(this, e))), await this._handleSessionLimit(a, c), this.createShards()
            }
            ...
            destroy() {
                if (!this.destroyed) {
                    ...
                    for (const e of this.shards.values()) e.destroy({closeCode: 1e3, reset: !0, emit: !1, log: !1})
                }
            }

            async _handleSessionLimit(e, t) {
                if (void 0 === e && void 0 === t) {
                    const {session_start_limit: s} = await this.client.api.gateway.bot.get();
        ...
        "use strict";
        const i = s(24), n = s(76), {browser: r, Status: o, Events: a, ShardEvents: c, OPCodes: l, WSEvents: h} = s(0),
            u = Object.keys(o), d = Object.keys(n.WebSocket);
        let p;
        if (!r) try {
            p = s(139)
        } catch {
        ...
        e.exports = class WebSocketShard extends i {
            constructor(e, t) {
                super(), this.manager = e, this.id = t, this.status = o.IDLE, this.sequence = -1, this.closeSequence = 0, this.sessionID = void 0, this.ping = -1, this.lastPingTimestamp = -1, this.lastHeartbeatAcked = !0, Object.defineProperty(this, "ratelimit", {
                    ...
                    value: void 0,
                    writable: !0
                }), Object.defineProperty(this, "connectedAt", {value: 0, writable: !0})
            }
            ...
            connect() {
                const {gateway: e, client: t} = this.manager;
            ...
            sendHeartbeat(e = "HeartbeatTimer", t = [o.WAITING_FOR_GUILDS, o.IDENTIFYING, o.RESUMING].includes(this.status)) {
                if (t && !this.lastHeartbeatAcked) this.debug(`[${e}] Didn't process heartbeat ack yet but we are still connected. Sending one now.`); else if (!this.lastHeartbeatAcked) return this.debug(`[${e}] Didn't receive a heartbeat ack last time, assuming zombie connection. Destroying and reconnecting.\n    Status          : ${u[this.status]}\n    Sequence        : ${this.sequence}\n    Connection State: ${this.connection ? d[this.connection.readyState] : "No Connection??"}`), void this.destroy({
                    closeCode: 4009,
                    reset: !0
                });
            ...
            identifyNew() {
                ...
                const t = {...e.options.ws, token: e.token, shard: [this.id, Number(e.options.shardCount)]};
                this.debug(`[IDENTIFY] Shard ${this.id}/${e.options.shardCount}`), this.send({op: l.IDENTIFY, d: t}, !0)
            }
            ...
            identifyResume() {
                ...
                const e = {token: this.manager.client.token, session_id: this.sessionID, seq: this.closeSequence};
                this.send({op: l.RESUME, d: e}, !0)
            }
            ...
            _send(e) {
                if (!this.connection || this.connection.readyState !== n.OPEN) return this.debug(`Tried to send packet '${JSON.stringify(e)}' but no WebSocket is available!`), void this.destroy({close: 4e3});
            ...
            processQueue() {
                if (0 !== this.ratelimit.remaining && 0 !== this.ratelimit.queue.length) for (this.ratelimit.remaining === this.ratelimit.total && (this.ratelimit.timer = this.manager.client.setTimeout(() => {
            ...
            destroy({closeCode: e = 1e3, reset: t = !1, emit: s = !0, log: i = !0} = {}) {
                if (i && this.debug(`[DESTROY]\n    Close Code    : ${e}\n    Reset         : ${t}\n    Emit DESTROYED: ${s}`), this.setHeartbeatTimer(-1), this.setHelloTimeout(-1), this.connection) if (this.connection.readyState === n.OPEN) this.connection.close(e); else {
        ...
        (function (e) {
            ...
            function h(e, s, i) {
                ...
                if (r) return r;
                var o = Object.keys(s), a = function (e) {
                    var t = {};
            ...
            function d(e, t, s, i, n, r) {
                var o, a, c;
                if ((c = Object.getOwnPropertyDescriptor(t, n) || {value: t[n]}).get ? a = c.set ? e.stylize("[Getter/Setter]", "special") : e.stylize("[Getter]", "special") : c.set && (a = e.stylize("[Setter]", "special")), w(i, n) || (o = "[" + n + "]"), a || (e.seen.indexOf(c.value) < 0 ? (a = g(s) ? h(e, c.value, null) : h(e, c.value, s - 1)).indexOf("\n") > -1 && (a = r ? a.split("\n").map((function (e) {
                    return "  " + e
                })).join("\n").substr(2) : "\n" + a.split("\n").map((function (e) {
                    return "   " + e
            ...
            t.debuglog = function (s) {
                if (_(r) && (r = e.env.NODE_DEBUG || ""), s = s.toUpperCase(), !o[s]) if (new RegExp("\\b" + s + "\\b", "i").test(r)) {
                    var i = e.pid;
                    o[s] = function () {
            ...
            function N() {
                var e = new Date, t = [b(e.getHours()), b(e.getMinutes()), b(e.getSeconds())].join(":");
        ...
        const {Events: i} = s(0);
        e.exports = (e, {d: t}) => {
            const s = e.channels.cache.get(t.channel_id), n = new Date(t.last_pin_timestamp);
        ...
        const {Events: i} = s(0);
        e.exports = (e, t) => {
            const {old: s, updated: n} = e.actions.ChannelUpdate.handle(t.d);
        ...
        const {Events: i} = s(0);
        e.exports = (e, {d: t}) => {
            const s = e.guilds.cache.get(t.guild_id), n = e.users.add(t.user);
        ...
        "use strict";
        const {Events: i, Status: n} = s(0);
        e.exports = async (e, {d: t}, s) => {
        ...
        "use strict";
        const i = s(2), {Events: n} = s(0);
        e.exports = (e, {d: t}) => {
            const s = e.guilds.cache.get(t.guild_id);
            if (!s) return;
            const r = new i;
            for (const e of t.members) r.set(e.user.id, s.members.add(e));
            if (t.presences) for (const e of t.presences) s.presences.cache.add(Object.assign(e, {guild: s}));
        ...
        const {Events: i} = s(0);
        e.exports = (e, t) => {
            const {old: s, updated: n} = e.actions.MessageUpdate.handle(t.d);
        ...
        let i;
        e.exports = (e, {d: t}, n) => {
            if (e.user) e.user._patch(t.user); else {
                i || (i = s(78));
        ...
        e.exports = (e, {d: t}) => {
            const s = e.channels.cache.get(t.channel_id), r = e.users.cache.get(t.user_id),
        ...
        Speaking.FLAGS = {SPEAKING: 1, SOUNDSHARE: 2, PRIORITY_SPEAKING: 4}, e.exports = Speaking
    }])
}));